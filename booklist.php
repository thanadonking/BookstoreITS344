								...
								<div class="post">
									...
									<div class="entry">
										...
										<?php
											...
											{
												echo '<a href="booklist.php?catid='.$_GET['catid'].'&catnm='.$_GET['catnm'].'&page='.($page_current_page+1).'">Next</a>';
											}
											
											for($i=1;$i<=$page_total_page;$i++)
											{
												echo '&nbsp;&nbsp;<a href="booklist.php?catid='.$_GET['catid'].'&catnm='.$_GET['catnm'].'&page='.$i.'">'.$i.'</a>&nbsp;&nbsp;';
											}
											
											if($page_current_page>1)
											{	
												echo '<a href="booklist.php?catid='.$_GET['catid'].'&catnm='.$_GET['catnm'].'&page='.($page_current_page-1).'">Previous</a>';
											}
